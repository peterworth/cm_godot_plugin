...
opts.Add('target_name', 'Resulting file name.', 'cm_godot_plugin')
...
sources = Glob('cm_godot_plugin/*.cpp')
sources.append(Glob('cm_godot_plugin/*.mm'))
sources.append(Glob('cm_godot_plugin/*.m'))
